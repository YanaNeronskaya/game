        ...
        if (this.player.alive) {
            ...
            gameOverPanel.onComplete.add(function () {
                ...
                if (this.underlavas) {
                    ...
                    this.add.text(this.game.width / 2, this.game.height / 2 - 200, 'We have no time for water!', style).anchor.setTo(0.5);
                }

                if (this.alienClash) {
                    let style = {font: '65px Orbitron, sans-serif', fill: '#fff'};
                    this.add.text(this.game.width / 2, this.game.height / 2 - 200, 'Bro, are you serious?', style).anchor.setTo(0.5);
                }

                if (this.ufoClash) {
                    let style = {font: '70px Orbitron, sans-serif', fill: '#fff'};
                    this.add.text(this.game.width / 2, this.game.height / 2 - 200, 'They fly faster than you commit', style).anchor.setTo(0.5);
                }

                if (this.obstacleClash) {
                    let style = {font: '70px Orbitron, sans-serif', fill: '#fff'};
                    this.add.text(this.game.width / 2, this.game.height / 2 - 200, 'Stumbled - fell', style).anchor.setTo(0.5);
                }
